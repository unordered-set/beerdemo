    ...
    return (
        <section className='Tokenomics' id="tokenomics">
            <div className="token__container">
                ...
                <div className="token__table">
                    <div className="token__table-text"><p id='p1'>90% &nbsp; Liquidity Pool</p></div>
                    <div className="token__table-text"><p id='p1'>3% &nbsp; Team</p></div>
                    <div className="token__table-text"><p id='p1'>3% &nbsp; Airdrops</p></div>
                    <div className="token__table-text"><p id='p1'>4% &nbsp; Marketing</p></div>
                </div>
