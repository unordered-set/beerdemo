...
function Games () { 
    return (
        ...
        <div className="container">
            ...
            <div className="info__img"><img src={gamesImg} alt="info_img" /></div>   
                <div className="info__textcontent">
                <div className="info__header"><h2><span id='info_header'>GAMES</span></h2></div>
                <div className="info__text"><p className='info_text-br'>In the $BEER token ecosystem, resembling a bar, there's an exciting feature: money-based games.</p>
<p>
